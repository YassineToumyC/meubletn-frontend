<template>
  <div class="list-page">
    <div class="list-hero list-hero--green">
      <div class="wrap">
        <nav class="breadcrumb"><NuxtLink to="/">Accueil</NuxtLink><span>/</span><span>Nouveautés</span></nav>
        <h1 class="list-hero-title">Nouveautés 2025</h1>
        <p class="list-hero-sub">Découvrez les dernières arrivées de notre catalogue</p>
      </div>
    </div>

    <div class="sort-bar">
      <div class="wrap sort-inner">
        <span class="sort-count">{{ products.length }} nouveaux produits</span>
...
useHead({ title: 'Nouveautés 2025 | meubletn' })
...
.list-hero--green { background: linear-gradient(135deg, #276749 0%, #134030 100%); }
...
.list-hero-sub { font-size: 15px; color: rgba(255,255,255,0.8); margin: 0; }
