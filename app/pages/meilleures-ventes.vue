<template>
  <div class="list-page">
    <div class="list-hero list-hero--dark">
      <div class="wrap">
        <nav class="breadcrumb"><NuxtLink to="/">Accueil</NuxtLink><span>/</span><span>Meilleures ventes</span></nav>
        <h1 class="list-hero-title">Meilleures ventes</h1>
        <p class="list-hero-sub">Les produits préférés de nos clients</p>
      </div>
    </div>

    <div class="sort-bar">
      <div class="wrap sort-inner">
        <span class="sort-count">{{ products.length }} produits</span>
...
useHead({ title: 'Meilleures ventes | meubletn' })
...
.list-hero-sub { font-size: 15px; color: rgba(255,255,255,0.75); margin: 0; }
